...
class ServicesLocator {
  void init() {
    ...
    // Créer deux instances de Dio - une pour l'API d'origine et une pour GNews
    sl.registerLazySingleton<Dio>( () {
      final dio = Dio(BaseOptions(
        // Gardez la baseUrl pour maintenir la compatibilité avec l'ancien code
      ...
      // Ajouter un intercepteur pour le débogage
